...
# use here the function from the method comparison on 30m height, and aplly to 70m and 148m 
...
plot(x = slow_profile_data$datetime, y = slow_profile_data$LE_Wm2_MBR, type = "l", 
     col = "purple", main = "70m height", ylab = "LE MBR system [W/m2]", xlab = "")
...
# save as png
ggsave(
  filename = "C:/Users/Lenovo/Downloads/MBR_70m.png",
  plot = H_MBR + LE_MBR,
